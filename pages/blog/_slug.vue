<template>
  <div class="article pt-10">
    <header class="mx-auto mb-3">
      ...
      <p class="w-3/4">
        FullStack Developer | Writer | Teacher | YouTuber | Netflix Lover |
        Tecnology lover | Open Source enthusiast
      </p>
    ...
    <footer class="md:w-4/5 markdown mt-6 mx-auto text-justify mb-3">
      <div class="head-post">
        <div
          class="time-categories flex-col md:flex-row flex justify-between md:items-center"
        >
          <time class="text-xs">
            {{ new Date(page.date).toLocaleDateString("pt") }}
          </time>
...
footer.markdown h1::before,
footer.markdown h2::before,
footer.markdown h4::before {
  content: "";
  position: absolute;
  left: 0;
  height: 10px;
